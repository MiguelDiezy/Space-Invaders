...
PLAYER_SPACESHIP = pygame.image.load("Porfolio Space INvaders/Assets/player_spaceship.png")
PLAYER_SPACESHIP = pygame.transform.scale(PLAYER_SPACESHIP, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT))
# Create Aliens and reescale them.
ALIEN_SPACESHIP = pygame.image.load("Porfolio Space INvaders/Assets/aliens.png")
ALIEN_SPACESHIP = pygame.transform.scale(ALIEN_SPACESHIP, (ALIEN_WIDTH, ALIEN_HEIGHT))

SPACE = pygame.transform.scale(pygame.image.load("Porfolio Space INvaders/Assets/space.png"), (WIDTH, HEIGHT))
